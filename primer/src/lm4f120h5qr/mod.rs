...
pub static ISR_VECTORS: [Option<unsafe extern "C" fn()>; 155] = [// Stack pointer
                                                                 Some(super::_stack_top),
                                                                 // Reset
                                                                 Some(super::startup),
                                                                 // NMI
                                                                 Some(super::isr_nmi),
                                                                 // Hard Fault
                                                                 Some(super::isr_hardfault),
                                                                 // CM3 Memory Management Fault
                                                                 Some(super::isr_mmfault),
                                                                 // CM3 Bus Fault
                                                                 Some(super::isr_busfault),
                                                                 // CM3 Usage Fault
                                                                 Some(super::isr_usagefault),
                                                                 ...
                                                                 None,
                                                                 // SVCall
                                                                 Some(super::isr_svcall),
                                                                 // Reserved for debug
                                                                 Some(super::isr_debugmon),
                                                                 // Reserved
                                                                 None,
                                                                 // PendSV
                                                                 Some(super::isr_pendsv),
                                                                 // SysTick
                                                                 Some(super::isr_systick),
                                                                 // GPIO Port A                      16
                                                                 Some(super::isr_empty_def),
                                                                 // GPIO Port B                      17
                                                                 Some(super::isr_empty_def),
                                                                 // GPIO Port C                      18
                                                                 Some(super::isr_empty_def),
